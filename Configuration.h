...
#define STRING_CONFIG_H_AUTHOR "Peter, v3.0, 30.12.21" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd_LIST {  87.59,  87.59 }
  #else
...
// Maximum reachable area
  ...
  #define DELTA_HEIGHT 274.4            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -4.52, -3.61, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 139.65              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.80, 1.52, -0.72 } // Get these values from G33 auto calibrate
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22.0, 10.0, -0.45 }
...
#define Z_PROBE_LOW_POINT         -20  // -2 // Farthest distance below the trigger-point to go before stopping
...
#define X_MIN_POS -(DELTA_PRINTABLE_RADIUS) -40.0
#define Y_MIN_POS -(DELTA_PRINTABLE_RADIUS) -40.0
#define Z_MIN_POS -5.0
#define X_MAX_POS DELTA_PRINTABLE_RADIUS +40.0
#define Y_MAX_POS DELTA_PRINTABLE_RADIUS +40.0
